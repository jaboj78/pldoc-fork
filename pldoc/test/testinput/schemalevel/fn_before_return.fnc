...
FUNCTION 
fn_before_return
/** Update fn_Before_returning[publ_id=pa_publ_id AND epsfile=pa_epsfile].GRAPHIC_LAST_MODIFIED with modification date from file system. 
